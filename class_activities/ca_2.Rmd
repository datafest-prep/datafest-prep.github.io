---
title: 'Activity 3B: Data Wrangling Practice'
output: 
  rmdformats::robobook:
    css: "homework.css"
    highlight: pygments
...
In [the last activity](https://sta175-s22.github.io/slides/data_wrangling.html) we covered some useful data wrangling functions from the `dplyr` package. In this activity, you will practice using these functions to explore the energy efficiency data we have been using for the rest of our activities. This allows you to try out these techniques on a larger data set.
